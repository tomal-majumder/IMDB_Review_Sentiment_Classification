...
def main():
    parser = argparse.ArgumentParser(description="Run LR sentiment classifier")
    parser.add_argument("--input", type=str, required=True, help="Path to input CSV with 'text' and 'label' columns")
    parser.add_argument("--output", type=str, default="lr_results.csv", help="Path to save output CSV with predictions")
